              ...
              foreach ($types as $type) : ?>
                  <?php if ($type == 'rule_type1') { ?>
                    <div class="box effect-fadein">
                      <div class="row">
                          <div class="col1">
                            <img src="/wordpress/wp-content/themes/project/original/img/campaign/series/step_01_b.png" alt="">
                          </div>
                          <div class="col2">
                              ...
                              <div class="btn-box">
                                  <a href="https://okwave.jp/list/new_question" class="r_btn btn_answer" target="_blank">回答する</a>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <?php if ($type == 'rule_type4') { ?>
                    <div class="present effect-fadein">
                        <div class="row">
                            <div class="col1"><img src="/wordpress/wp-content/themes/project/original/img/campaign/series/step_02_b.png" alt="02"></div>
                            <div class="col2">
                                <h3 class="headline2"><?php the_sub_field('cp_rule_type4_sub_headline'); ?></h3>
                                <p><?php the_sub_field('cp_rule_type4_body'); ?></p>
                            </div>
                        </div>
                    </div>
                  <?php } ?>
